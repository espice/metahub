    ...
    return (
      <div className={styles.content}>
        <div className={styles.content__container}>
          ...
          <Textfield value={userName} onChange={(e) => {setUserName(e.target.value)}} type={"email"} placeholder={"Your Email"} className={styles.content__container__input}></Textfield>
    ...
    return (
      <div className={styles.content}>
        <div className={styles.content__container}>
          ...
          <TagTextField num={num} value={userNamee} onChange={(e) => {setUserNamee(e.target.value)}} type={"text"} placeholder={"Your Username"} className={styles.content__container__input}></TagTextField>
          ...
          <Textfield value={userBday} onChange={(e) => {setUserBday(e.target.value)}} type={"date"} placeholder={"Your Password"} className={styles.content__container__input}></Textfield>
          ...
          }>Let's Go! {"(for real this time)"}</PrimaryButton>
